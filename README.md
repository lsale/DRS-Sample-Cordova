...
## 1. Requirements
To run this sample on iOS and Android, using the Amazon Dash Login Plugin (for Cordova), you will need to have Xcode and the Android SDK installed locally.
...
The [amazon-dash-cordova-login-plugin](https://github.com/amzn/amazon-dash-cordova-login-plugin) provides you with access to the Login with Amazon Mobile SDK and Single-Sign-On functionality for customers who have the Amazon Shopping app installed (i.e. they won't need to type their username and password). 
...
Instructions to customize the installation with your own API key and package name are available on the [plugin github page](https://github.com/amzn/amazon-dash-cordova-login-plugin).
...
1. Run `cp extras/assets/api_key.txt platforms/android/app/src/main/assets/`
...
**Important**: if you wish to change the deviceModel or the package/bundle name, you will have to generate your own API Key from your [Security Profile](https://developer.amazon.com/loginwithamazon/console/site/lwa/overview.html) and update:
